...
func (s *grpcServer) Hash(ctx oldContext.Context, r *pb.HashRequest) (*pb.HashResponse, error) {
...
func (s *grpcServer) Validate(ctx oldContext.Context, r *pb.ValidateRequest) (*pb.ValidateResponse, error) {
