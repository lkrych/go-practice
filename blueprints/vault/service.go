...
func decodeHashRequest(ctx newContext.Context, r *http.Request) (interface{}, error) {
	var req hashRequest
...
func decodeValidateRequest(ctx newContext.Context, r *http.Request) (interface{}, error) {
...
func encodeResponse(ctx newContext.Context, w http.ResponseWriter, response interface{}) error {
	return json.NewEncoder(w).Encode(response)
}

func MakeHashEndpoint(srv Service) endpoint.Endpoint {
	return func(ctx newContext.Context, request interface{}) (interface{}, error) {
